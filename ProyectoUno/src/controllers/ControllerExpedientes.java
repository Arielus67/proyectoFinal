...
/**
 * Controlador para la gestión de expedientes médicos de pacientes. Muestra
 * citas asociadas a un paciente y lista de pacientes registrados.
 *
 * @author Luis
 * @author Ariel
 */
public class ControllerExpedientes {
	...
	/**
	 * Constructor del controlador de expedientes. Inicializa ventana, archivos y
	...
	private void loadTableExpediente() {
		try {
			...
			if (!encontrado) {
				JOptionPane.showMessageDialog(null, "El expediente no está disponible o no existe el expediente",
	...
	/**
	 * Carga en la tabla de expedientes las citas del paciente cuya identificación
	 * se ingresó en el campo de consulta.
	 */
	private void loadTableExpediente() {
		try {
			modelExpediente.setRowCount(0);
