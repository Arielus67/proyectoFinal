...
/**
 * Controlador para generación y visualización de reportes. Permite consultar
 * listas ordenadas de pacientes, médicos, citas por médico, por mes, historial
 * por paciente, citas atendidas/canceladas.
 *
 * @author Luis
 * @author Ariel
 * @version 1.0
...
public class ControllerReportes {
	...
	/**
	 * Constructor. Inicializa ventana, archivos y carga combo de meses.
	 *
	...
	of https:// github.com/Arielus67/proyectoFinal.git
