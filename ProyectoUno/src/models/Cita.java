...
public class Cita {
	...
	public Cita(Paciente paciente, Medico medico, EstadoCita estado,char delimiter,int hora, String mes ) {
		super();
		this.id=generarId();
		this.paciente = paciente;
		this.medico = medico;
